...
CREATE TABLE `comment` (
  ...
  KEY `FK_PostComment` (`PostID`),
  CONSTRAINT `FK_PostComment` FOREIGN KEY (`PostID`) REFERENCES `post` (`PostID`),
...
INSERT INTO `comment` VALUES (139,'น่ากลัวมาก','2023-10-13 22:43',130,135,'2023-10-13 22:43');
